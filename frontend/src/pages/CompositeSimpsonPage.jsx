...
import { CompositeSimpson } from "../utils";
...
export default function CompositeSimpsonPage() {
    ...
    const CompositeSimpsonlCal = ({ a, b, fx ,n}) => {
        try {
            const cal = new CompositeSimpson(a, b, fx,n);
            const res = cal.solve();
    ...
    return (
        <Box p={6} bg="gray.700" minW="100vw" minH="100vh" overflowX="hidden">
            <VStack spacing={6}>
                ...
                <Center>
                    <IntegretionWithN onCalculate={CompositeSimpsonlCal} />
                </Center>
